...
c+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
c HISTORY
C 27Feb1999 disabled fields > 0.98T until parametrization is corrected. 
c
...
c Grind through the parameterization
      ...
      if (B0 .le. CUTOFF) then
         ...
         B = B0 * (1 - (B0 - CUTOFF)**2 * QUADRATIC / EFL_0 )
         B = 0. 
C temporarily disabled until para are fixed
         write(*,*) 'Parametrization B> ',CUTOFF,' disabled'
      endif
...
c                        Q1        Q2        Q3    
      data cutoff   /   2.114,    2.409,    2.389  /
      data constant /   0.139,    0.277,    0.271  /
      data linear   / 297.38,   189.89,   189.28   /
      data cubic    /   9.55,    12.99,    12.68   /
