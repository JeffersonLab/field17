...
c     the 1.5% correction has been taken into account
      ...
      bdl1=befl_q1*p_HMS/6.*golden1
      bdl2=befl_q2*p_HMS/6.*golden2
      bdl3=befl_q3*p_HMS/6.*golden3
...
c     Calculate Q1, Q2, Q3 Current conversion factor
      ...
      I_Q1=fac1*bdl1/renorm_mom
      I_Q2=fac2*bdl2/renorm_mom
      I_Q3=fac3*bdl3/renorm_mom
      
      type *,'Set current for Q1 = ',I_Q1*sign_HMS*-1.
      type *,'Set current for Q2 = ',I_Q2*sign_HMS
      type *,'Set current for Q3 = ',I_Q3*sign_HMS*-1.
